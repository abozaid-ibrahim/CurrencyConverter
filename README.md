...
## Setup Configs
* Open the project by double clicking the `CurrencyConverter.xcworkspace` file
```
// App Settings
APP_NAME = CurrencyConverter (Dev)
PRODUCT_BUNDLE_IDENTIFIER = com.abuzeid.CurrencyConverter
